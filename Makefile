#############################################################################
# Makefile for building: harbour-tagesschau
# Generated by qmake (3.0) (Qt 5.2.2)
# Project:  harbour-tagesschau.pro
# Template: app
# Command: /usr/lib/qt5/bin/qmake QMAKE_CFLAGS_RELEASE=-O2\ -g\ -pipe\ -Wall\ -Wp,-D_FORTIFY_SOURCE=2\ -fexceptions\ -fstack-protector\ --param=ssp-buffer-size=4\ -Wformat\ -Wformat-security\ -m32\ -march=i486\ -fasynchronous-unwind-tables QMAKE_CFLAGS_DEBUG=-O2\ -g\ -pipe\ -Wall\ -Wp,-D_FORTIFY_SOURCE=2\ -fexceptions\ -fstack-protector\ --param=ssp-buffer-size=4\ -Wformat\ -Wformat-security\ -m32\ -march=i486\ -fasynchronous-unwind-tables QMAKE_CXXFLAGS_RELEASE=-O2\ -g\ -pipe\ -Wall\ -Wp,-D_FORTIFY_SOURCE=2\ -fexceptions\ -fstack-protector\ --param=ssp-buffer-size=4\ -Wformat\ -Wformat-security\ -m32\ -march=i486\ -fasynchronous-unwind-tables QMAKE_CXXFLAGS_DEBUG=-O2\ -g\ -pipe\ -Wall\ -Wp,-D_FORTIFY_SOURCE=2\ -fexceptions\ -fstack-protector\ --param=ssp-buffer-size=4\ -Wformat\ -Wformat-security\ -m32\ -march=i486\ -fasynchronous-unwind-tables QMAKE_STRIP=: PREFIX=/usr -spec linux-g++-32 CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile harbour-tagesschau.pro
#############################################################################
...
CFLAGS        = -m32 -pipe -O2 -g -pipe -Wall -Wp,-D_FORTIFY_SOURCE=2 -fexceptions -fstack-protector --param=ssp-buffer-size=4 -Wformat -Wformat-security -m32 -march=i486 -fasynchronous-unwind-tables -fPIC -fvisibility=hidden -fvisibility-inlines-hidden -Wall -W -D_REENTRANT -fPIE $(DEFINES)
CXXFLAGS      = -m32 -pipe -O2 -g -pipe -Wall -Wp,-D_FORTIFY_SOURCE=2 -fexceptions -fstack-protector --param=ssp-buffer-size=4 -Wformat -Wformat-security -m32 -march=i486 -fasynchronous-unwind-tables -fPIC -fvisibility=hidden -fvisibility-inlines-hidden -Wall -W -D_REENTRANT -fPIE $(DEFINES)
INCPATH       = -I/usr/share/qt5/mkspecs/linux-g++-32 -I. -I/usr/include/sailfishapp -I/usr/include/mdeclarativecache5 -I/usr/include/qt5 -I/usr/include/qt5/QtQuick -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtQml -I/usr/include/qt5/QtNetwork -I/usr/include/qt5/QtCore -I.
LINK          = g++
LFLAGS        = -m32 -Wl,-rpath,/usr/share/harbour-tagesschau/lib
...
DIST          = /usr/share/qt5/mkspecs/features/spec_pre.prf \
		...
		harbour-tagesschau.pro \
		harbour-tagesschau.pro
QMAKE_TARGET  = harbour-tagesschau
...
Makefile: harbour-tagesschau.pro /usr/share/qt5/mkspecs/linux-g++-32/qmake.conf /usr/share/qt5/mkspecs/features/spec_pre.prf \
		/usr/share/qt5/mkspecs/common/shell-unix.conf \
		/usr/share/qt5/mkspecs/common/unix.conf \
		/usr/share/qt5/mkspecs/common/linux.conf \
		/usr/share/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) QMAKE_CFLAGS_RELEASE=-O2\ -g\ -pipe\ -Wall\ -Wp,-D_FORTIFY_SOURCE=2\ -fexceptions\ -fstack-protector\ --param=ssp-buffer-size=4\ -Wformat\ -Wformat-security\ -m32\ -march=i486\ -fasynchronous-unwind-tables QMAKE_CFLAGS_DEBUG=-O2\ -g\ -pipe\ -Wall\ -Wp,-D_FORTIFY_SOURCE=2\ -fexceptions\ -fstack-protector\ --param=ssp-buffer-size=4\ -Wformat\ -Wformat-security\ -m32\ -march=i486\ -fasynchronous-unwind-tables QMAKE_CXXFLAGS_RELEASE=-O2\ -g\ -pipe\ -Wall\ -Wp,-D_FORTIFY_SOURCE=2\ -fexceptions\ -fstack-protector\ --param=ssp-buffer-size=4\ -Wformat\ -Wformat-security\ -m32\ -march=i486\ -fasynchronous-unwind-tables QMAKE_CXXFLAGS_DEBUG=-O2\ -g\ -pipe\ -Wall\ -Wp,-D_FORTIFY_SOURCE=2\ -fexceptions\ -fstack-protector\ --param=ssp-buffer-size=4\ -Wformat\ -Wformat-security\ -m32\ -march=i486\ -fasynchronous-unwind-tables QMAKE_STRIP=: PREFIX=/usr -spec linux-g++-32 CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile harbour-tagesschau.pro
...
dist: 
	@test -d .tmp/harbour-tagesschau1.0.0 || mkdir -p .tmp/harbour-tagesschau1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/harbour-tagesschau1.0.0/ && $(COPY_FILE) --parents src/harbour-tagesschau.cpp .tmp/harbour-tagesschau1.0.0/ && (cd `dirname .tmp/harbour-tagesschau1.0.0` && $(TAR) harbour-tagesschau1.0.0.tar harbour-tagesschau1.0.0 && $(COMPRESS) harbour-tagesschau1.0.0.tar) && $(MOVE) `dirname .tmp/harbour-tagesschau1.0.0`/harbour-tagesschau1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/harbour-tagesschau1.0.0
...
harbour-tagesschau.o: src/harbour-tagesschau.cpp /usr/include/qt5/QtQuick/QtQuick \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o harbour-tagesschau.o src/harbour-tagesschau.cpp

####### Install

install_qml: first FORCE
	@test -d $(INSTALL_ROOT)/usr/share/harbour-tagesschau || mkdir -p $(INSTALL_ROOT)/usr/share/harbour-tagesschau
	-$(INSTALL_DIR) /home/mersdk/share/Dokumente/Projekte/harbour-tagesschau/qml $(INSTALL_ROOT)/usr/share/harbour-tagesschau/

uninstall_qml: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/harbour-tagesschau/qml
	-$(DEL_DIR) $(INSTALL_ROOT)/usr/share/harbour-tagesschau/ 
...
install_desktop: first FORCE
	...
	-$(INSTALL_FILE) /home/mersdk/share/Dokumente/Projekte/harbour-tagesschau/harbour-tagesschau.desktop $(INSTALL_ROOT)/usr/share/applications/

uninstall_desktop: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/applications/harbour-tagesschau.desktop
...
install_icon: first FORCE
	...
	-$(INSTALL_FILE) /home/mersdk/share/Dokumente/Projekte/harbour-tagesschau/harbour-tagesschau.png $(INSTALL_ROOT)/usr/share/icons/hicolor/86x86/apps/

uninstall_icon: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/icons/hicolor/86x86/apps/harbour-tagesschau.png
